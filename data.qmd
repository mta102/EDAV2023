...
4. rounding errors - estimates do not sum to 100% due to 1 dp rounding of estimates in raw data - causes sum of calculated sub-samples not to sum to total of sample.size
...
Geography = National
Group.Name = Segment
Group.Category = Subsegments (no need to manually specify)
...
Approach:
1.	Snapshot analysis - Study which segments of the population exhibited greatest covid vaccine hesitancy following the deployment of mass vaccinations in the US in early 2021
...
o	Mosaic
o	spatial heatmap
- w-average first 3 periods where overall hesitance ~18% 

2.	Time series analysis - Analyse which segments showed the greatest reduction in covid vaccine hesitancy between 2021 and 2023 as:
...
3. Propose high-level recommendations for segments of the population that need further public health interventions
