...
# Within the Indicator Name, NAs are in the Vaccination uptake & intention and received vaccination rows, indicating that Estimates for these are blank
covid |>  filter(is.na(`Estimate (%)`)) |> ggplot(aes(y = fct_rev(fct_infreq(`Indicator Name`)))) +
